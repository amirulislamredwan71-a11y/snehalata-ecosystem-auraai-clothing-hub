// Bangladesh administrative locations — all 64 districts with their full upazila list
// (Dhaka district also includes Dhaka Metropolitan thanas). Source: bangladesh-geocode
// (bd_geo_code). Consumed by the checkout district->area dropdown and vendor onboarding.
